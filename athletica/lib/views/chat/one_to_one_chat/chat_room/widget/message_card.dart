...
class _GroupMessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isSender = widget.messageModel.sendBy == senderPhone;
        ...
        Center(
          child: Container(
            ...
            child: Text(
              _chatService.formatDate(widget.messageModel.time),
              style:
              const TextStyle(color: messageTextShowColor, fontWeight: FontWeight.bold),
            ),
          ),
        ),
      if (shouldShowDate())
          ...
          child: IntrinsicWidth(
            child: Container(
              decoration: BoxDecoration(
                ...
                color: isSender ? messageTileColor : messageTileColor2,
              ),
